...
# Set the folder path
setwd("D:/Graduation_Thesis/01 Download/10 JRC_GFC2020/EA_GFC")
...
output_folder <- "D:/Graduation_Thesis/01 Download/10 JRC_GFC2020/EA_Results"
output_file <- file.path(output_folder, "EA_GFC_30km.tif")
...
writeRaster(merged_raster, filename = "D:/Graduation_Thesis/EA_Results/EA_GFC_30km.tif", format = "GTiff", overwrite = TRUE)
