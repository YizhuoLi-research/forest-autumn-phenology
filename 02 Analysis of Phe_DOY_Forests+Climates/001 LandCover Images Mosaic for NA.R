...
# Set the folder path
setwd("D:/Graduation_Thesis/01 Download/09 MODIS_Landcover/NA_LandCover")
...
output_folder <- "D:/Graduation_Thesis/01 Download/09 MODIS_Landcover/NA_Results"
...
writeRaster(merged_raster, filename = "D:/Graduation_Thesis/NA_Results/NA_LandCover_30km.tif",
