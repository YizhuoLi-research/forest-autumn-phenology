...
r1 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_TXx_phe3_4.tif")
r2 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_TXge30_phe3_4.tif")
r3 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_TNn_phe3_4.tif")
r4 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_TNlt2_phe3_4.tif")
r5 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_DTR_phe3_4.tif")
r6 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_RainDay_phe3_4.tif")
r7 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_CWD_phe3_4.tif")
r8 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_CDD_phe3_4.tif")
r9 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_RX1day_phe3_4.tif")
r10 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_SDII_phe3_4.tif")
r11 <- rast("./EA+NA_Results/merged_partial_corr_result/with_GDO/partial_corr_merged_Duration_phe3_4.tif")
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_TXX_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_TXge30_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_TNn_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_TNlt2_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_DTR_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_Rainday_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_CWD_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_CDD_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_Rx1day_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_SDII_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-GDO_Duration_phe3_4.tiff",
...
p11 <- ggplot() +
  ...
  scale_fill_stepsn(
    ...
    guide = guide_colorsteps(
      barwidth = 1.5,  # 调整图例宽度
      barheight = 30,  # 调整图例高度
      title.position = "left",  # 图例标题放在左侧
      # 标题竖向排列，字体大小和样式
      title.theme = element_text(angle = 90, hjust = 0.5, vjust = 0.5, size = 27), 
      frame.colour = "gray50",  # 图例外框颜色
      frame.linewidth = 0.5,  # 图例外框宽度
      ticks.colour = "gray50",  # 每个色块之间的框线颜色
      ticks.linewidth = 0.5 ))+ # 每个色块之间的框线宽度
  theme_minimal() +
  theme( panel.background = element_blank(),
         axis.ticks = element_blank(),
         axis.title = element_blank(),
         axis.text = element_blank(),
         legend.key = element_rect(colour = "gray50", size = 0.5), # **每个色阶的框线**
         legend.title.align = 0.5,  # 标题居中
         # legend.title = element_text(size = 50, face = "bold"),  # 调整标题字体大小和样式
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.GDO/Fig.S-legend-纵向.tiff",
  plot = p11,  width = 15,  height = 15,  units = "in",  dpi = 300)
