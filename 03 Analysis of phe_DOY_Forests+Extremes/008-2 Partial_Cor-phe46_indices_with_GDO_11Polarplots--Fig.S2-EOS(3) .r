...
r1 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TXx_phe4_6.tif")
r2 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TXge30_phe4_6.tif")
r3 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TNn_phe4_6.tif")
r4 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TNlt2_phe4_6.tif")
r5 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_DTR_phe4_6.tif")
r6 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_RainDay_phe4_6.tif")
r7 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_CWD_phe4_6.tif")
r8 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_CDD_phe4_6.tif")
r9 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_RX1day_phe4_6.tif")
r10 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_SDII_phe4_6.tif")
r11 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_merged_Duration_phe4_6.tif")
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TXX_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TXge30_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TNn_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TNlt2_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_DTR_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_Rainday_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_CWD_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_CDD_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_Rx1day_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_SDII_phe4_6.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_Duration_phe4_6.tiff",
