...
# 保存结果
# 1.温度指标 5层
writeRaster(Temp_phe1_3, "./EA_Results/3.Clim_Duration_Extremes/Temp_phe1_3_2022.tif", overwrite = TRUE)
writeRaster(Temp_phe3_4, "./EA_Results/3.Clim_Duration_Extremes/Temp_phe3_4_2022.tif", overwrite = TRUE)
writeRaster(Temp_phe4_6, "./EA_Results/3.Clim_Duration_Extremes/Temp_phe4_6_2022.tif", overwrite = TRUE)

# 2.降水指标 5层
writeRaster(Prcp_phe1_3, "./EA_Results/3.Clim_Duration_Extremes/Prcp_phe1_3_2022.tif", overwrite = TRUE)
writeRaster(Prcp_phe3_4, "./EA_Results/3.Clim_Duration_Extremes/Prcp_phe3_4_2022.tif", overwrite = TRUE)
writeRaster(Prcp_phe4_6, "./EA_Results/3.Clim_Duration_Extremes/Prcp_phe4_6_2022.tif", overwrite = TRUE)

# 3.物候指标 1层
writeRaster(Duration_phe1_3, "./EA_Results/3.Clim_Duration_Extremes/Duration_phe1_3_2022.tif", overwrite = TRUE)
writeRaster(Duration_phe3_4, "./EA_Results/3.Clim_Duration_Extremes/Duration_phe3_4_2022.tif", overwrite = TRUE)
writeRaster(Duration_phe4_6, "./EA_Results/3.Clim_Duration_Extremes/Duration_phe4_6_2022.tif", overwrite = TRUE)
