...
r1 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TXx_phe3_4.tif")
r2 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TXge30_phe3_4.tif")
r3 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TNn_phe3_4.tif")
r4 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_TNlt2_phe3_4.tif")
r5 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_DTR_phe3_4.tif")
r6 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_RainDay_phe3_4.tif")
r7 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_CWD_phe3_4.tif")
r8 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_CDD_phe3_4.tif")
r9 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_RX1day_phe3_4.tif")
r10 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_SDII_phe3_4.tif")
r11 <- rast("./EA+NA_Results/merged_partial_corr_result/with_EOS/partial_corr_merged_Duration_phe3_4.tif")
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TXX_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TXge30_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TNn_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_TNlt2_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_DTR_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_Rainday_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_CWD_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_CDD_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_Rx1day_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_SDII_phe3_4.tiff",
...
ggsave(
  filename = "./0.figure/03 Paper/Fig.S.EOS/Fig.S-EOS_Duration_phe3_4.tiff",
